;;; csproj-mode-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "csproj-mode" '("csproj-mode--get-dotnet-new-templates")))
